...
#define OV9655_DEVICE_WRITE_ADDRESS (0x60)>>1
#define OV9655_DEVICE_READ_ADDRESS 	(0x61)>>1

#define OV9655_NUMBER_REGISTER 	200

/* Definition registres camera OV9655 */
...
#define PRESCALER_3 	0x02
#define PRESCALER_4 	0x03
...
#define RGB_565 			0x10
#define RGB_555 			0x30
#define RGB_OUT_FULL 		0xC0
#define RGB_565_OUT_FULL 	0xD0
