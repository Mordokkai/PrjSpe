    ...
    slider.setup = function(type) {
      ...
      if (!fade) {
        ...
        if (vars.animationLoop && !carousel) {
		  ...
		  // hack to add 3 clones instead of one
          slider.container.append(slider.slides.eq(1).clone().addClass('clone')).prepend(slider.slides.eq(slider.count).clone().addClass('clone'));
          slider.container.append(slider.slides.eq(2).clone().addClass('clone')).prepend(slider.slides.eq(slider.count-2).clone().addClass('clone'));
		  // end hack
        }
...
/* Show/hide contribute widget */
$('.contribute').click(function () {
	$(".contribute").toggleClass("open");
	$('.contribution-options').toggle();
	return false;
});
